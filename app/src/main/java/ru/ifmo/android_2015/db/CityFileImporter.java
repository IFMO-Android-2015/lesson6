...
public abstract class CityFileImporter implements CityParserCallback {
    ...
    private SQLiteStatement insert = db.compileStatement(
    ...
    public CityFileImporter(SQLiteDatabase db) {
        this.db = db;
        //insert = db.compileStatement(EXPRESSION);
    }
        ...
        try {
            ...
            if (insert != null) {
                try {
                    ...
                    Log.e(LOG_TAG, "SQLiteStatement is not closed: " + e, e);
                }
            }
            db.endTransaction();
        }
    ...
    private boolean insertCity(SQLiteDatabase db,
       ...
       //final ContentValues values = new ContentValues();
        ...
        long rowId = insert.executeInsert();//(CityContract.Cities.TABLE, null, values);
